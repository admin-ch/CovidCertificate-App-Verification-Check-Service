...
object TestData {
    ...
    @JvmStatic
    fun getInvalidSigningKeys(): List<Jwk> {
        val n =
    ...
    fun getHardcodedSigningKeys(flavor: String): List<Jwk> {
        ...
        when (flavor) {
            "dev" -> {
                ...
                jwks.add(
                    Jwk.fromXY(
                        LI_DEV_ABN_VACCINATION_KID,
                        LI_DEV_ABN_VACCINATION_X,
                        LI_DEV_ABN_VACCINATION_Y,
                        use = "v"
                    )
                )
                jwks.add(
                ...
                jwks.add(
                    Jwk.fromXY(
                        LI_DEV_ABN_RECOVERY_KID,
                        LI_DEV_ABN_RECOVERY_X,
                        LI_DEV_ABN_RECOVERY_Y,
                        use = "r"
                    )
                )
            }
