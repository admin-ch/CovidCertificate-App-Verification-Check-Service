...
# Copy binary
ADD ./ch-covidcertificate-backend-verification-check/ch-covidcertificate-backend-verification-check-ws/target/ch-covidcertificate-backend-verification-check-ws.jar /home/verification-ws/bin/ch-covidcertificate-backend-verification-check-ws.jar
